...
def feature_extraction(state, info):
    ...
    curvature = np.mean(rowCentered[10:13]) - np.mean(rowCentered[6:10]) 
    ...
    return rowCenteresWeighted, rowCentered, avg_center_point, avg_center_point_for_top_rows, avg_center_point_for_last_rows, steering_intensity, speed, acceleration_intensity, curvature, sensitivity_factor
...
def policy(state, info, eval_mode = False, params = []):
    ...
    rowCenteresWeighted, rowCentered, avg_center_point, avg_center_point_for_top_rows, avg_center_point_for_last_rows, steering_intensity, speed, acceleration_intensity, curvature, sensitivity_factor = feature_extraction(state, info)

    steering_features = np.array(rowCenteresWeighted[9:] + [curvature, steering_intensity, avg_center_point_for_last_rows])  # Features for steering 28
    ...
    acceleration_features = np.array([speed, curvature, avg_center_point, avg_center_point_for_top_rows, avg_center_point_for_last_rows, acceleration_intensity, sensitivity_factor]) # 
